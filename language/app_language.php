<?php
	...
	$app_lang['account_deactive']="Sorry ! Your account is deactived";
	...
	// for message sent
	$app_lang['suggest_msg']="Your have successfully submitted your suggestion, it will be reviewed by admin and upload if necessary";
