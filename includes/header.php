            ...
            <aside class="app-sidebar" id="sidebar">
                ...
                <div class="sidebar-menu">
                    <ul class="sidebar-nav">
                        ...
                        <li <?php if ($currentFile == "manage_language.php" or $currentFile == "add_language.php") { ?>class="active"<?php } ?>> 
                            <a href="manage_language.php">
                                <div class="icon"> <i class="fa fa-language" aria-hidden="true"></i> </div>
                                <div class="title">Language</div>
                            </a> 
                        </li>
                        <li <?php if ($currentFile == "manage_city.php" or $currentFile == "add_city.php") { ?>class="active"<?php } ?>> 
                        ...
                        <li <?php if ($currentFile == "manage_radio.php" or $currentFile == "add_radio.php" or $currentFile == "edit_radio.php") { ?>class="active"<?php } ?>> 
                        ...
                        <li <?php if ($currentFile == "manage_video.php" or $currentFile == "add_video.php" or $currentFile == "edit_video.php") { ?>class="active"<?php } ?>> 
                            <a href="manage_video.php">
                        ...
                        <li <?php if ($currentFile == "manage_theme.php" or $currentFile == "add_theme.php") { ?>class="active"<?php } ?>> 
                            <a href="manage_theme.php">
                                <div class="icon"> <i class="fa fa-sitemap" aria-hidden="true"></i> </div>
