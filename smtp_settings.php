                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="radio radio-inline" style="margin-top: 10px">
                                        <input type="radio" name="smtp_type" id="gmail" value="gmail" <?php
...
?>>
                                    ...
                                    <div class="radio radio-inline" style="margin-top: 10px">
                                        <input type="radio" name="smtp_type" id="server" value="server" <?php
                                        if ($row['smtp_type'] == 'server') {
                                            echo ' checked="" disabled="disabled"';
                                        }
                                        ?>>
                                        <label for="server">
                            ...
                            ?>>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="smtp_host[]" class="form-control" value="<?= $row['smtp_ghost'] ?>" placeholder="mail.example.in" <?php
                            if ($row['smtp_type'] == 'gmail') {
                                echo 'required';
                            }
                            ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="smtp_email[]" class="form-control" value="<?= $row['smtp_gemail'] ?>" placeholder="info@example.com" <?php
                            if ($row['smtp_type'] == 'gmail') {
                                echo 'required';
                            }
                            ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <select name="smtp_secure[]" class="select2" <?php
                            if ($row['smtp_type'] == 'gmail') {
                                echo 'required';
                            }
                            ?>>
                                            <option value="tls" <?php
                                               if ($row['smtp_gsecure'] == 'tls') {
                                                   echo 'selected';
                                               }
                                               ?>>TLS</option>
                                            <option value="ssl" <?php
                                               if ($row['smtp_gsecure'] == 'ssl') {
                                                   echo 'selected';
                                               }
                                               ?>>SSL</option>
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="port_no[]" class="form-control" value="<?= $row['gport_no'] ?>" placeholder="Enter Port No." <?php
                            if ($row['smtp_type'] == 'gmail') {
                                echo 'required';
                            }
                                               ?>>
                            ...
                            <div class="serverContent" <?php
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">SMTP Host <span style="color: red">*</span>:-</label>
                                    <div class="col-md-6">
                                        <input type="text" name="smtp_host[]" id="smtp_host" class="form-control" value="<?= $row['smtp_host'] ?>" placeholder="mail.example.in" <?php
                                        if ($row['smtp_type'] == 'server') {
                                            echo 'required';
                                        }
                                        ?>>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Email <span style="color: red">*</span>:-</label>
                                    <div class="col-md-6">
                                        <input type="text" name="smtp_email[]" id="smtp_email" class="form-control" value="<?= $row['smtp_email'] ?>" placeholder="info@example.com" <?php
                                                    if ($row['smtp_type'] == 'server') {
                                                        echo 'required';
                                                    }
                                                    ?>>
                                ...
                                <div class="form-group">
                                        ...
                                        <select name="smtp_secure[]" class="select2" <?php
                                            if ($row['smtp_type'] == 'server') {
                                                echo 'required';
                                                    ...
                                                    ?>>
                                            <option value="tls" <?php
                                            if ($row['smtp_secure'] == 'tls') {
                                                echo 'selected';
                                            }
                                                    ?>>TLS</option>
                                            <option value="ssl" <?php
                                            if ($row['smtp_secure'] == 'ssl') {
                                                echo 'selected';
                                            }
                                                    ?>>SSL</option>
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="port_no[]" id="port_no" class="form-control" value="<?= $row['port_no'] ?>" placeholder="Enter Port No." <?php
if ($row['smtp_type'] == 'server') {
    echo 'required';
}
?>>
                ...
                <div class="alert alert-danger alert-dismissible fade in" role="alert">
                    <h4 id="oh-snap">Note:<a class="anchorjs-link" href="#oh-snap!-you-got-an-error!"><span class="anchorjs-icon"></span></a></h4>
