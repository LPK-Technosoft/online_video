...
if (isset($_GET['status'])) {
    ...
    $targetpage = "manage_video.php?status=" . $_GET['status'];
    ...
    $targetpage = "manage_video.php?keyword=" . $_GET['keyword'];
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="block_wallpaper">
                                    ...
                                    <span><img src="<?= ($row['video_thumbnail'] != '') ? 'images/video/' . $row['video_thumbnail'] : 'assets/images/square.jpg' ?>" /></span>
                                </div>
                            </div>
                            <?php
                            $i++;
